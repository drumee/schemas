...
--
-- Deliberately not called for trash: a trashed file can be restored, and the
-- threads should keep waiting.
--
...
main: BEGIN
  ...
  WHERE holder_hub_id = _holder_hub_id
    AND holder_file_nid = _holder_file_nid
