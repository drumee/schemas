...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  `mfs_root` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `user_root` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `site_root` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
