...
CREATE TABLE `country` (
  ...
  `cc_iso` varchar(3) collate utf8_general_ci NOT NULL,
  `fr` varchar(200) collate utf8_general_ci NOT NULL,
  `en` varchar(200) collate utf8_general_ci NOT NULL,
  PRIMARY KEY  (`id`),
  KEY `fr` (`fr`),
  KEY `en` (`en`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=239 ;
 
--
-- Contenu de la table `pays`
--
 
INSERT INTO `country` (`id`, `cc_iso`, `fr`, `en`) VALUES
